...
// Need to break out of mem when we error
const getGoodreadsData = mem(
    async (searchTitle, searchAuthor) => {
        ...
        try {
            ...
            console.error("XML Parsing Failing", e);
            return noMatchFound;
        }
        ...
        if (numberOfResults > 1) {
            ...
            let filteredResults = allResults
                .filter((searchResult) => {
                    ...
                    const title =
                        searchResult.best_book[0].title[0].toLowerCase();
            ...
            if (filteredResults.length > 1) {
                ...
                const allTitlesMatch = allTitles.every(
